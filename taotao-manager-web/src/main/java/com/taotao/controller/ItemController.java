...
//		//1.引入服务
	...
	/**
	 * 修改商品之前查询描述 /rest/item/query/item/desc/816448
	 * 
	 */
	@RequestMapping(value = "/rest/item/query/item/desc/{itemId}", method = RequestMethod.GET)
	@ResponseBody
	public EasyUIDataGridResult queryItemDesc(@PathVariable(value = "itemId") Long itemId) {
		return itemservice.queryItemDesc(itemId);
	}

	/**
	 * 修改商品之前查询规格参数 /rest/item/param/item/query/816753
	 */
	@RequestMapping(value = "/rest/item/param/item/query/{itemId}", method = RequestMethod.GET)
	@ResponseBody
	public EasyUIDataGridResult queryItemParam(@PathVariable(value = "itemId") Long itemId) {
	...
	@ResponseBody
	public TaotaoResult deleteItemParam(@RequestParam(value = "ids", defaultValue = "0") Long id) {
		return itemservice.deleteItemParam(id);
	}

	@RequestMapping(value = "/item/param/query/itemcatid/{itemcatId}", method = RequestMethod.GET)
	@ResponseBody
	public EasyUIDataGridResult queryItemCatId(@PathVariable(value = "itemcatId") Integer itemcatId) {
		return itemservice.queryItemCatId(itemcatId);
	}
	...
	@ResponseBody
	public TaotaoResult saveItemParam(@PathVariable(value = "itemcatId") Long itemcatId, String paramData) {
		return itemservice.saveItemParam(itemcatId, paramData);
	}
